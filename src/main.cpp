...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Technocoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Technocoin: 2.5 minutes
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc1, 0xb3, 0xda }; // Technocoin: increase each by adding 2 to bitcoin's value.
